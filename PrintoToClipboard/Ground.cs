...
namespace PrintoToClipboard
{
    public partial class Ground : Form
    {
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            {
                MessageBox.Show("Print Canceled", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void key_press(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode.ToString() == "P" && (RectangleDrawn && (CursorPosition() == CursPos.WithinSelectionArea || CursorPosition() == CursPos.OutsideSelectionArea)))
            {

                SaveSelection(true);

            }
            else if(e.KeyCode.ToString() == "C" && (RectangleDrawn && (CursorPosition() == CursPos.WithinSelectionArea || CursorPosition() == CursPos.OutsideSelectionArea)))
            {
                this.Close();
                this.InstanceRef.Show();
                MessageBox.Show("Print Canceled", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
